...
class Site extends TimberSite
{
    ...
    public function __construct()
    {
        ...
        add_filter('timber/render/file', array($this, 'maybe_load_password_template'));
    ...
    public function child_add_to_twig($twig)
    {
        ...
        $twig->addFunction(new \Twig\TwigFunction('get_image_sizes', [ImageHelper::class, 'get_image_sizes']));
